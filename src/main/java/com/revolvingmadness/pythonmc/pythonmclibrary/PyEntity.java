...
public class PyEntity {
	...
	public boolean isInRange(PyEntity entity, double range) {
		return this.entity.isInRange(entity.entity, range);
	}
	...
	public void setOnFireFor(int seconds) {
		this.entity.setOnFireFor(seconds);
	}
	...
	public void damage(PyDamageSources source, float amount) {
		this.entity.damage(source.toDamageSource(this.entity.world), amount);
	}
